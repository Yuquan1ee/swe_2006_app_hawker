...
class CustomerSettingController {              //contains 3 functions: changePassword(String username, String newPassword), change Username (String oldUsername, String newUsername), changeemail(String, username, String newemail)
